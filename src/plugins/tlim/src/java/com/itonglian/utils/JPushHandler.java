...
public class JPushHandler implements Runnable{
    ...
    public JPushHandler(String user_id) {
    ...
    public void run() {
        try {
            ...
            PushPayload payload = buildPushObject_all_all_alert(user_id);
    ...
    public static PushPayload buildPushObject_all_all_alert(String msgTo) {
        ...
        return PushPayload.newBuilder()
                ...
                .setNotification(Notification.ios_auto_badge().newBuilder().setAlert("Hello,"+msgTo+",时间["+MessageUtils.getTs()+"]").build())
                .build();
    }
}
