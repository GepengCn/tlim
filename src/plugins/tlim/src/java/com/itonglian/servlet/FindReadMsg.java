...
public class FindReadMsg extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        super.init(config);
        AuthCheckFilter.addExclude("tlim/findReadMsg");
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        doBack(new BackJson("ok","",statusDao.findMsgRead(session_id)),printWriter);
