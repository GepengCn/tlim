...
public class MsgReadOrNot extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        super.init(config);
        AuthCheckFilter.addExclude("tlim/msgReadOrNot");
    }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int result = statusDao.readOrNot(msg_id,msg_to);

        doBack(new BackJson("ok","",result),printWriter);
    ...
    private class BackJson{
        ...
        public BackJson(String result, String result_detail, int readOrNot) {
            this.result = result;
