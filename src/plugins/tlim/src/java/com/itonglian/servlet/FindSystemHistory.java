...
public class FindSystemHistory extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        super.init(config);
        AuthCheckFilter.addExclude("tlim/findSystemHistory");
    ...
    private class BackJson{
        ...
        public BackJson(String result, String result_detail, List<OfMessage> message_list,int total) {
            this.result = result;
            this.result_detail = result_detail;
